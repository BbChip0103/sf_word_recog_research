...
with tf.Session(graph=g, config=tf.ConfigProto(log_device_placement=False, gpu_options=tf.GPUOptions(allow_growth=False))) as sess:
    
    max_epoch = 100  
    result_dir = './model/cnn_2conv_2fc'
